...
cp 48K/*.tap ZX_The_Queen_s_Footsteps_it/48K

# Notes for this distribution.
cp notes_ZXSpectrum.txt ZX_The_Queen_s_Footsteps_it

cp P3/*.dsk ZX_The_Queen_s_Footsteps_it/P3

rm  ZX_Queens_it.zip
zip -r ZX_Queens_it.zip ZX_The_Queen_s_Footsteps_it
cp ZX_Queens_it.zip $ditdir
...
rm ZX_The_Queen_s_Footsteps_it/P3/SPC3queen.dsk
# Create a new disk image and import the three files for TQF.
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/SPC3queen.dsk -n
# Loader
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/SPC3queen.dsk -i DISK.
# Loading screen
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/SPC3queen.dsk -i ZXQUEENS.SCR
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/SPC3queen.dsk -i queens1.bin -f
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/SPC3queen.dsk -i queens2.bin -f
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/SPC3queen.dsk -i queens3.bin -f
...
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/TDTTR.dsk -i PART2
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/TDTTR.dsk -i ZXTWODA2.BIN
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/TDTTR.dsk -i PART3
$pp/idsk/iDSK ZX_The_Queen_s_Footsteps_it/P3/TDTTR.dsk -i ZXTWODA3.BIN
